...
namespace Infrastructure.Data.Ado.Dapper
{
    ...
    static partial class SqlMapper
    {
        ...
        /// </summary>
        private class Link<TKey, TValue>
            where TKey : class
        {
        ...
        public class Identity : IEquatable<Identity>
        {
                ...
                int gridIndex)
            {
                ...
                unchecked
                {
                    ...
                    this.hashCode = this.hashCode * 23
            ...
            {
                return other != null && this.gridIndex == other.gridIndex && this.type == other.type
                       && this.sql == other.sql && this.commandType == other.commandType
    ...
    /// <returns>Number of rows affected</returns>
            ...
            )
        {
            ...
            return ExecuteCommand(
                ...
                transaction,
                sql,
                (object)param == null ? null : info.ParamReader,
                (object)param,
                commandTimeout,
                commandType);
        }
    ...
    /// </summary>
        ...
        {
            return MultiMap<TFirst, TSecond, DontMap, DontMap, DontMap, DontMap, DontMap, TReturn>(
                cnn,
                sql,
                map,
                param as object,
        ...
        {
            return MultiMap<TFirst, TSecond, TThird, DontMap, DontMap, DontMap, DontMap, TReturn>(
                cnn,
                sql,
                map,
                param as object,
        ...
        {
            return MultiMap<TFirst, TSecond, TThird, TFourth, DontMap, DontMap, DontMap, TReturn>(
                cnn,
                sql,
                map,
                param as object,
        ...
        public static IEnumerable<TReturn> Query<TFirst, TSecond, TThird, TFourth, TFifth, TReturn>(
            ...
            CommandType? commandType = null)
        {
            return MultiMap<TFirst, TSecond, TThird, TFourth, TFifth, DontMap, DontMap, TReturn>(
                cnn,
                sql,
                map,
                param as object,
        ...
        public static IEnumerable<TReturn> Query<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TReturn>(
            ...
            CommandType? commandType = null)
        {
            return MultiMap<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, DontMap, TReturn>(
                cnn,
                sql,
                map,
                param as object,
        ...
        public static IEnumerable<TReturn> Query<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TReturn>(
            ...
            CommandType? commandType = null)
        {
            return MultiMap<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TReturn>(
                cnn,
                sql,
                map,
                param as object,
            ...
            CommandType? commandType)
        {
            IEnumerable<TReturn> results =
                MultiMapImpl<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TReturn>(
                    cnn,
                    sql,
                    map,
                    param,
        ...
        private static Func<IDataReader, object>[] GenerateDeserializers(
            Type[] types,
            string splitOn,
            IDataReader reader)
        {
            ...
            foreach (Type type in types)
            {
                if (type != typeof(DontMap))
                {
                    ...
                    deserializers.Add(
                        GetDeserializer(type, reader, split, next - split, /* returnNullIfFirstMissing: */ !first));
                    first = false;
                    split = next;
                }
            }
        ...
        private static Func<IDataReader, object> GetDeserializer(
            Type type,
            IDataReader reader,
            int startBound,
            int length,
            bool returnNullIfFirstMissing)
        {
            ...
            if (
                !(typeMap.ContainsKey(type) || type.IsEnum || type.FullName == LinqBinary
        ...
        private sealed class DapperTable
        {
            ...
            internal int AddField(string name)
            {
                ...
                Array.Resize(ref this.fieldNames, oldLen + 1);
        ...
        private sealed class DapperRowMetaObject : DynamicMetaObject
        {
            ...
            private static readonly MethodInfo setValueMethod = typeof(DapperRow).GetMethod(
                "SetValue",
            ...
            public override DynamicMetaObject BindGetMember(GetMemberBinder binder)
            {
                ...
                DynamicMetaObject callMethod = this.CallMethod(getValueMethod, parameters);
            ...
            public override DynamicMetaObject BindSetMember(SetMemberBinder binder, DynamicMetaObject value)
            {
                ...
                DynamicMetaObject callMethod = this.CallMethod(setValueMethod, parameters);
        ...
        private sealed class DapperRow : IDynamicMetaObjectProvider, IDictionary<string, object>
        {
            ...
            {
                int index = this.table.IndexOfName(name);
                if (index < 0)
                {
                    // doesn't exist
                    value = null;
        ...
        public static IDbDataParameter FindOrAddParameter(
        ...
        public static Action<IDbCommand, object> CreateParamInfoGenerator(Identity identity, bool checkForDuplicates)
        {
            ...
            var dm = new DynamicMethod(
                string.Format("ParamInfo{0}", Guid.NewGuid()),
                null,
            ...
            foreach (PropertyInfo prop in props)
            {
                ...
                else
                {
                    ...
                    il.EmitCall(
                        OpCodes.Callvirt,
                        typeof(IDataParameter).GetProperty("ParameterName").GetSetMethod(),
        ...
        private static IDbCommand SetupCommand(
            IDbConnection cnn,
            IDbTransaction transaction,
            string sql,
...
#pragma warning restore 618
        ...
        private static readonly MethodInfo enumParse = typeof(Enum).GetMethod(
            "Parse",
            new[] { typeof(Type), typeof(string), typeof(bool) }),
                                           getItem =
                                               typeof(IDataRecord).GetProperties(
        ...
        private static MethodInfo GetOperator(Type from, Type to)
        {
            ...
            return ResolveOperator(
                fromMethods = from.GetMethods(BindingFlags.Static | BindingFlags.Public),
                from,
                to,
                "op_Implicit")
                   ?? ResolveOperator(
                       toMethods = to.GetMethods(BindingFlags.Static | BindingFlags.Public),
                       from,
                       to,
                       "op_Implicit")
        ...
        public class GridReader : IDisposable
        {
            ...
            {
                return this.Read<DapperRow>(buffered);
            }
#endif
    ...
    /// </summary>
...
#endif
            {
                ...
                Identity typedIdentity = this.identity.ForGrid(typeof(T), this.gridIndex);
                ...
                {
                    deserializer = new DeserializerState(hash, GetDeserializer(typeof(T), this.reader, 0, -1, false));
                    cache.Deserializer = deserializer;
                }
                this.consumed = true;
                IEnumerable<T> result = this.ReadDeferred<T>(this.gridIndex, deserializer.Func, typedIdentity);
            ...
            {
                Identity identity = this.identity.ForGrid(
                    typeof(TReturn),
                    new[]
                        {
                            typeof(TFirst), typeof(TSecond), typeof(TThird), typeof(TFourth), typeof(TFifth),
    ...
    /// </summary>
...
#endif
            {
                IEnumerable<TReturn> result =
                    this.MultiReadInternal<TFirst, TSecond, DontMap, DontMap, DontMap, DontMap, DontMap, TReturn>(
                        func,
                        splitOn);
                return buffered ? result.ToList() : result;
            }
    ...
    /// </summary>
            ...
            {
                IEnumerable<TReturn> result =
                    this.MultiReadInternal<TFirst, TSecond, TThird, DontMap, DontMap, DontMap, DontMap, TReturn>(
                        func,
                        splitOn);
                return buffered ? result.ToList() : result;
            }
    ...
    /// </summary>
            ...
            {
                IEnumerable<TReturn> result =
                    this.MultiReadInternal<TFirst, TSecond, TThird, TFourth, DontMap, DontMap, DontMap, TReturn>(
                        func,
                        splitOn);
                return buffered ? result.ToList() : result;
            }
            ...
            {
                IEnumerable<TReturn> result =
                    this.MultiReadInternal<TFirst, TSecond, TThird, TFourth, TFifth, DontMap, DontMap, TReturn>(
                        func,
                        splitOn);
                return buffered ? result.ToList() : result;
            }
            ...
            {
                IEnumerable<TReturn> result =
                    this.MultiReadInternal<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, DontMap, TReturn>(
                        func,
                        splitOn);
                return buffered ? result.ToList() : result;
            }
            ...
            {
                IEnumerable<TReturn> result =
                    this.MultiReadInternal<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TReturn>(
                        func,
                        splitOn);
                return buffered ? result.ToList() : result;
            }
            ...
            private IEnumerable<T> ReadDeferred<T>(
                int index,
                Func<IDataReader, object> deserializer,
    ...
    partial class DynamicParameters : SqlMapper.IDynamicParameters
    {
        ...
        {
            object val = this.parameters[Clean(name)].AttachedParam.Value;
            if (val == DBNull.Value)
            {
                if (default(T) != null)
                {
        ...
        protected void AddParameters(IDbCommand command, SqlMapper.Identity identity)
        {
            ...
            foreach (ParamInfo param in this.parameters.Values)
            {
...
#pragma warning restore 612, 618
    ...
    sealed partial class DbString : SqlMapper.ICustomQueryParameter
    {
        ...
        public void AddParameter(IDbCommand command, string name)
        {
            ...
            param.DbType = this.IsAnsi
                               ? (this.IsFixedLength ? DbType.AnsiStringFixedLength : DbType.AnsiString)
                               : (this.IsFixedLength ? DbType.StringFixedLength : DbType.String);
    ...
    sealed partial class DefaultTypeMap : SqlMapper.ITypeMap
    {
        ...
        public ConstructorInfo FindConstructor(string[] names, Type[] types)
        {
            ConstructorInfo[] constructors =
                this._type.GetConstructors(BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic);
            foreach (
        ...
        public SqlMapper.IMemberMap GetMember(string columnName)
        {
            PropertyInfo property =
                this._properties.FirstOrDefault(p => string.Equals(p.Name, columnName, StringComparison.Ordinal))
                ?? this._properties.FirstOrDefault(
            ...
            FieldInfo field =
                this._fields.FirstOrDefault(p => string.Equals(p.Name, columnName, StringComparison.Ordinal))
                ?? this._fields.FirstOrDefault(
                    p => string.Equals(p.Name, columnName, StringComparison.OrdinalIgnoreCase));
