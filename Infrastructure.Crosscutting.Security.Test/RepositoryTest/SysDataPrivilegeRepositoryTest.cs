...
namespace Infrastructure.Crosscutting.Security.Test.RepositoryTest
{
    ...
    public class SysDataPrivilegeRepositoryTest
    {
        ...
        {
            repository = new SysDataPrivilegeRepository();
        }
        ...
        public void GetTest()
        {
            ...
            if (model != null)
            {
                Console.WriteLine(model.DataPrivilegeView);
            }
            else
            {
        ...
        {
            int total = 0;
            var s = repository.GetPaged("Sys_DataPrivilege", "", "DataPrivilegeView='View2'", "", 1, 20, 0, out total);
        }
    }
}
